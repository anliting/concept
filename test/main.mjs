...
console.log(
  ...
  'Proof: Externally controlled fragment.',
)
console.log(
  all(function*(){
    let a=0,b=0
...
console.log(
  ...
  'useState: Setter accepts functions.',
)
console.log(
  all(function*(){
    let root=new Root('a')
  ...
  'String concept is treated as text node.',
)
console.log(
  all(function*(){
    let root=new Root(component(()=>'a')())
    yield root.node.childNodes[0].wholeText=='a'
    root.render(component(()=>'b')())
    yield root.node.childNodes[0].wholeText=='b'
  }()),
  'String concept is treated as text node.',
)
console.log(
  ...
  'Non-string iterable concept is treated as fragment.',
)
console.log(
  all(function*(){
    let C=component(()=>{})
  ...
  'Component can be called without explicit prop.',
)
if(0){
  console.log(
    [...function*(){
